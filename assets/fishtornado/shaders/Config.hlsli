...
#define RENDER_MODEL_DATA_REGISTER                 b1 // MODEL_SPACE
#define RENDER_MATERIAL_DATA_REGISTER              b2 // MATERIAL_SPACE
#define RENDER_FLOCKING_DATA_REGISTER              b3 // FLOCKING_SPACE
#define RENDER_SHADOW_SAMPLER_REGISTER             s4 // SCENE_SPCE
#define RENDER_CLAMPED_SAMPLER_REGISTER            s5 // MATERIAL_SPACE
#define RENDER_REPEAT_SAMPLER_REGISTER             s6 // MATERIAL_SPACE
#define RENDER_SHADOW_TEXTURE_REGISTER             t7 // SCENE_SPCE
#define RENDER_ALBEDO_TEXTURE_REGISTER             t8 // MATERIAL_SPACE
#define RENDER_ROUGHNESS_TEXTURE_REGISTER          t9 // MATERIAL_SPACE
#define RENDER_NORMAL_MAP_TEXTURE_REGISTER         t10 // MATERIAL_SPACE
#define RENDER_CAUSTICS_TEXTURE_REGISTER           t11 // MATERIAL_SPACE
...
#define RENDER_CURRENT_VELOCITY_TEXTURE_REGISTER   t14 // FLOCKING_SPACE
#define RENDER_OUTPUT_POSITION_TEXTURE_REGISTER    u15 // FLOCKING_SPACE
#define RENDER_OUTPUT_VELOCITY_TEXTURE_REGISTER    u16 // FLOCKING_SPACE
