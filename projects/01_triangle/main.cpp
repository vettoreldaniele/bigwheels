...
private:
    grfx::MultiObject<grfx::CommandBuffer> cmd;
    grfx::MultiObject<grfx::Semaphore>     imageAcquiredSemaphore;
    grfx::MultiObject<grfx::Fence>         imageAcquiredFence;
    grfx::MultiObject<grfx::Semaphore>     renderCompleteSemaphore;
...
void ProjApp::Setup()
{
    ...
    // Per frame data
    {
        PPX_CHECKED_CALL(GetGraphicsQueue()->CreateMultiCommandBuffer(GetMultiObjectCreateInfo(), cmd));

        grfx::SemaphoreCreateInfo semaCreateInfo = {};
        PPX_CHECKED_CALL(GetDevice()->CreateMultiSemaphore(&semaCreateInfo, GetMultiObjectCreateInfo(), imageAcquiredSemaphore));

        grfx::FenceCreateInfo fenceCreateInfo = {};
        PPX_CHECKED_CALL(GetDevice()->CreateMultiFence(&fenceCreateInfo, GetMultiObjectCreateInfo(), imageAcquiredFence));

        PPX_CHECKED_CALL(GetDevice()->CreateMultiSemaphore(&semaCreateInfo, GetMultiObjectCreateInfo(), renderCompleteSemaphore));
