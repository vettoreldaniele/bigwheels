    ...
    {
        {
            ...
            PPX_CHECKED_CALL(pApp->CompileHlslShader(pApp->GetAssetPath("fishtornado/shaders"), "OceanBeam", "vs_5_0", &VS));
            PPX_CHECKED_CALL(pApp->CompileHlslShader(pApp->GetAssetPath("fishtornado/shaders"), "OceanBeam", "ps_5_0", &PS));
#else
