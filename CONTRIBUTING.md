...
that you have either authored or are able to license for BigWheels to use.

When creating a use license for your assets, we prefer that you use one of the
following licenses:
