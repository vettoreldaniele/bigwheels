...
enum Result
{
    ...
    ERROR_GRFX_OBJECT_OWNERSHIP_IS_RESTRICTED       = -1000,
    ERROR_GRFX_UNSUPPORTED_SWAPCHAIN_FORMAT         = -1001,
    ERROR_GRFX_UNSUPPORTED_PRESENT_MODE             = -1002,
    ERROR_GRFX_MAX_VERTEX_BINDING_EXCEEDED          = -1003,
    ERROR_GRFX_VERTEX_ATTRIBUTE_FROMAT_UNDEFINED    = -1004,
    ERROR_GRFX_VERTEX_ATTRIBUTE_OFFSET_OUT_OF_ORDER = -1005,
    ERROR_GRFX_CANNOT_MIX_VERTEX_INPUT_RATES        = -1006,
    ERROR_GRFX_UNKNOWN_DESCRIPTOR_TYPE              = -1007,
    ERROR_GRFX_BINDING_NOT_IN_SET                   = -1008,
    ERROR_GRFX_NON_UNIQUE_SET                       = -1009,
    ERROR_GRFX_MINIMUM_BUFFER_SIZE_NOT_MET          = -1010,
