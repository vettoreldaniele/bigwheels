...
enum Result
{
    ...
    ERROR_GRFX_DESCRIPTOR_COUNT_EXCEEDED            = -1009,
    ERROR_GRFX_BINDING_NOT_IN_SET                   = -1010,
    ERROR_GRFX_NON_UNIQUE_SET                       = -1011,
    ERROR_GRFX_MINIMUM_BUFFER_SIZE_NOT_MET          = -1012,
    ERROR_GRFX_INVALID_SHADER_BYTE_CODE             = -1013,
    ERROR_INVALID_PIPELINE_INTERFACE                = -1014,
    ERROR_GRFX_INVALID_QUERY_TYPE                   = -1015,
    ERROR_GRFX_INVALID_QUERY_COUNT                  = -1016,
    ERROR_GRFX_NO_QUEUES_AVAILABLE                  = -1017,
