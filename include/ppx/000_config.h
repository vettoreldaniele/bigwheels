...
enum Result
{
    ...
    ERROR_GRFX_INVALID_QUERY_TYPE                   = -1014,
    ERROR_GRFX_INVALID_QUERY_COUNT                  = -1015,
    ERROR_GRFX_NO_QUEUES_AVAILABLE                  = -1016,

    ERROR_IMAGE_FILE_LOAD_FAILED               = -2000,
    ERROR_IMAGE_CANNOT_RESIZE_EXTERNAL_STORAGE = -2001,
    ERROR_IMAGE_INVALID_FORMAT                 = -2002,
    ERROR_IMAGE_RESIZE_FAILED                  = -2003,
    ERROR_BITMAP_CREATE_FAILED                 = -2004,
    ERROR_BITMAP_BAD_COPY_SOURCE               = -2005,
    ERROR_BITMAP_FOOTPRINT_MISMATCH            = -2006,
