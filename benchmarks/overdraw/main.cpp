...
void ProjApp::Setup()
{
    ...
    // Texture image and view
    {
        ...
        PPX_CHECKED_CALL(ppxres = grfx_util::CreateImageFromFile(GetDevice()->GetGraphicsQueue(), GetAssetPath("benchmarks/textures/bricks_" + res + ".png"), &mImage, options, false));
