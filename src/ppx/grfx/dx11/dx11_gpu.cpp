...
#define PPX_MAX_DX11_GRAPHICS_QUEUES 1
#define PPX_MAX_DX11_COMPUTE_QUEUES  2
#define PPX_MAX_DX11_COPY_QUEUES     2
...
{
    return PPX_MAX_DX11_GRAPHICS_QUEUES;
}

uint32_t Gpu::GetComputeQueueCount() const
{
    return PPX_MAX_DX11_COMPUTE_QUEUES;
}

uint32_t Gpu::GetTransferQueueCount() const
{
    return PPX_MAX_DX11_COPY_QUEUES;
}
