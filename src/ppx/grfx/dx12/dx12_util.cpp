...
enum
{
    DXVK_D3D12_RESOURCE_STATE_PRESENT = 0xF0000001,
};

enum
{
    DXVK_D3D12_DESCRIPTOR_RANGE_TYPE_SRV_BUFFER            = D3D12_DESCRIPTOR_RANGE_TYPE_SAMPLER + 1,
    DXVK_D3D12_DESCRIPTOR_RANGE_TYPE_SRV_STRUCTURED_BUFFER = DXVK_D3D12_DESCRIPTOR_RANGE_TYPE_SRV_BUFFER + 1,
    DXVK_D3D12_DESCRIPTOR_RANGE_TYPE_SRV_TEXTURE           = DXVK_D3D12_DESCRIPTOR_RANGE_TYPE_SRV_STRUCTURED_BUFFER + 1,
    DXVK_D3D12_DESCRIPTOR_RANGE_TYPE_UAV_BUFFER            = DXVK_D3D12_DESCRIPTOR_RANGE_TYPE_SRV_TEXTURE + 1,
    DXVK_D3D12_DESCRIPTOR_RANGE_TYPE_UAV_STRUCTURED_BUFFER = DXVK_D3D12_DESCRIPTOR_RANGE_TYPE_UAV_BUFFER + 1,
    DXVK_D3D12_DESCRIPTOR_RANGE_TYPE_UAV_TEXTURE           = DXVK_D3D12_DESCRIPTOR_RANGE_TYPE_UAV_STRUCTURED_BUFFER + 1,
};
...
#if defined(PPX_DXVK)
        case grfx::DESCRIPTOR_TYPE_SAMPLED_IMAGE: return static_cast<D3D12_DESCRIPTOR_RANGE_TYPE>(DXVK_D3D12_DESCRIPTOR_RANGE_TYPE_SRV_TEXTURE);
        case grfx::DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER: return static_cast<D3D12_DESCRIPTOR_RANGE_TYPE>(DXVK_D3D12_DESCRIPTOR_RANGE_TYPE_SRV_BUFFER);
        case grfx::DESCRIPTOR_TYPE_STRUCTURED_BUFFER: return static_cast<D3D12_DESCRIPTOR_RANGE_TYPE>(DXVK_D3D12_DESCRIPTOR_RANGE_TYPE_SRV_STRUCTURED_BUFFER);
#else
...
#if defined(PPX_DXVK)
        case grfx::DESCRIPTOR_TYPE_STORAGE_IMAGE: return static_cast<D3D12_DESCRIPTOR_RANGE_TYPE>(DXVK_D3D12_DESCRIPTOR_RANGE_TYPE_UAV_TEXTURE);
        case grfx::DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER: return static_cast<D3D12_DESCRIPTOR_RANGE_TYPE>(DXVK_D3D12_DESCRIPTOR_RANGE_TYPE_UAV_BUFFER);
        case grfx::DESCRIPTOR_TYPE_STORAGE_BUFFER: return static_cast<D3D12_DESCRIPTOR_RANGE_TYPE>(DXVK_D3D12_DESCRIPTOR_RANGE_TYPE_UAV_STRUCTURED_BUFFER);
#else
